...
<!-- main-area -->
    <main>
          ...
          <div class="row justify-content-center">
            <div class="col-xl-12 col-lg-10">
              ...
              <div class="community-content">
                <p>
                  The HP ProBook is a line of business-oriented laptop computers
                  made by Hewlett-Packard (HP Inc.).HP marketed the ProBook
                  series to business users; the list price was lower than that
                  of HP's higher-end EliteBook series
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 col-sm-10 pb-100">
              <div class="team-item">
                <div class="team-thumb">
                  <a href="#"><img src="{{ asset('user/assets/img/lappy/hp1.jpg') }}" alt="" /></a>
                </div>
                <div class="team-content">
                  <h2 class="title"><a href="#">HP ProDesk 600 G1</a></h2>
              ...
              <div class="team-item">
                <div class="team-thumb">
                  <a href="team-details.html"
                    ><img src="{{ asset('user/assets/img/lappy/hp2.jpg') }}" alt=""
                  /></a>
                </div>
                <div class="team-content">
                  <h2 class="title"><a href="#">HP ProDesk 800 G1</a></h2>
            ...
            <div class="col-lg-4 col-md-6 col-sm-10">
              <div class="team-item">
                <div class="team-thumb">
                  <a href="team-details.html"
                    ><img src="{{ asset('user/assets/img/lappy/hp3.jpg') }}" alt=""
                  /></a>
                </div>
                <div class="team-content">
                  <h2 class="title"><a href="#">HP EliteDesk-705 G2</a></h2>
                  <!-- <span>CEO Kawasaki Inc.</span> -->
                  <div class="team-social">
                    <ul class="list-wrap" style="display: block">
                      <li><span>Sleek & Light Weight</span></li>
            ...
            <div class="col-lg-4 col-md-6 col-sm-10">
              <div class="team-item">
                <div class="team-thumb">
                  <a href="team-details.html"
                    ><img src="{{ asset('user/assets/img/lappy/hp4.jpg') }}" alt=""
                  /></a>
                </div>
                <div class="team-content">
                  <h2 class="title"><a href="#">HP280-G3-MT Core i3</a></h2>
                  <!-- <span>CEO Kawasaki Inc.</span> -->
                  <div class="team-social">
                    <ul class="list-wrap" style="display: block">
                      <li><span>Sleek & Light Weight</span></li>
            ...
            <div class="col-lg-4 col-md-6 col-sm-10">
              <div class="team-item">
                <div class="team-thumb">
                  <a href="team-details.html"
                    ><img src="{{ asset('user/assets/img/lappy/hp5.jpg') }}" alt=""
                  /></a>
                </div>
                <div class="team-content">
                  <h2 class="title"><a href="#">HP PRO 400 DESKTOP-C I7</a></h2>
                  <!-- <span>CEO Kawasaki Inc.</span> -->
                  <div class="team-social">
                    <ul class="list-wrap" style="display: block">
                      <li><span>Sleek & Light Weight</span></li>
            ...
            <div class="col-lg-4 col-md-6 col-sm-10">
              <div class="team-item">
                <div class="team-thumb">
                  <a href="team-details.html"
                    ><img src="{{ asset('user/assets/img/lappy/hp6.jpg') }}" alt=""
                  /></a>
                </div>
                <div class="team-content">
                  <h2 class="title">
                    <a href="#">HP ProDesk 400 G5 Core i5</a>
                  </h2>
                  <div class="team-social">
                    <ul class="list-wrap" style="display: block">
                      <li><span>Sleek & Light Weight</span></li>
      ...
      <!-- brand-area -->
      <!-- <section class="brand-area-two pt-50 pb-110">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-6">
