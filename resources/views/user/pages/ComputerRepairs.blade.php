              ...
              <div class="blog-details-wrap">
                <div class="bd-content-top text-center">
                  ...
                  <div class="blog-details-img">
                    <img
                      style="width: 2000px"
                      src="{{ asset('user/assets/img/lappy/computer-repair.jpg') }}"
                      alt=""
                    />
                  </div>

                  <h2 class="title">Computer Repair Services</h2>
                  <p style="text-align: left;">
                    Lappystore undertake Desktop Computer Repair and Services of
                    all companies make and model. Team Lappystore has a set of
                    Trained and ceritfied technicians expertised in desktop
