...
<!-- main-area -->
        <main>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumb-content">
                                <h2 class="title">Apple imac series</h2>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Apple imac series</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-12 col-lg-10">
                            ...
                            <div class="community-content">
                                <p>iMac is a family of all-in-one Mac desktop computers designed and built by Apple Inc. It has been the primary part of Apple's consumer desktop offerings since its debut in August 1998, and has evolved through seven distinct forms</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- team-area -->
            <section class="team-area-two pt-110 ">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 col-sm-10 pb-100">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <a href="#"><img src="{{ asset('user/assets/img/lappy/a1.jpg') }}" alt=""></a>
                                </div>
                                <div class="team-content ">
                                    <h2 class="title"><a href="#">Apple iMac A1312</a></h2>                                    
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <a href="team-details.html"><img src="{{ asset('user/assets/img/lappy/a2.jpg') }}" alt=""></a>
                                </div>
                                <div class="team-content">
                                    <h2 class="title"><a href="#">Apple iMac 21.5</a></h2>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <a href="team-details.html"><img src="{{ asset('user/assets/img/lappy/a3.jpg') }}" alt=""></a>
                                </div>
                                <div class="team-content">
                                    <h2 class="title"><a href="#">Apple iMac A1311</a></h2>
                                    <!-- <span>CEO Kawasaki Inc.</span> -->
                                    <div class="team-social">
                                        <ul class="list-wrap" style="display: block;">
                                            <li><span>Sleek & Light Weight</span></li>
                        ...
                        <!-- <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <a href="team-details.html"><img src="assets/img/lappy/d4.jpg" alt=""></a>
                                </div>
                                <div class="team-content">
                                    <h2 class="title"><a href="#">Lenovo-Core-i3-6th(Gen)</a></h2>
                                    <div class="team-social">
                                        <ul class="list-wrap" style="display: block;">
                                            <li><span>Sleek & Light Weight</span></li>
                                            <li><span>Excellent Performance</span></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <a href="team-details.html"><img src="assets/img/lappy/d5.jpg" alt=""></a>
                                </div>
                                <div class="team-content">
                                    <h2 class="title"><a href="#">Lenovo-V520-Tower</a></h2>
                                    <div class="team-social">
                                        <ul class="list-wrap" style="display: block;">
                                            <li><span>Sleek & Light Weight</span></li>
                                            <li><span>Excellent Performance</span></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <a href="team-details.html"><img src="assets/img/lappy/d6.jpg" alt=""></a>
                                </div>
                                <div class="team-content">
                                    <h2 class="title"><a href="#">Lenovo AIO 330</a></h2>
                                    <div class="team-social">
                                        <ul class="list-wrap" style="display: block;">
                                            <li><span>Sleek & Light Weight</span></li>
                                            <li><span>Excellent Performance</span></li>
            ...
            <!-- brand-area -->
            <!-- <section class="brand-area-two pt-50 pb-100 ">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
