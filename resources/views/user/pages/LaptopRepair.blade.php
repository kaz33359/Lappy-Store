                ...
                <div class="bd-content-top text-center">
                  ...
                  <div class="blog-details-img">
                    <img
                      ...
                      src="{{ asset('user/assets/img/lappy/Laptop Repair.jpg') }}"
                      alt=""
                    />
                  </div>

                  <h2 class="title">Laptop Repair</h2>
                  <p style="text-align: left;">
                    ...
                    parts with warranty. If your system has the same trouble in
                    the next 30 days, we provide free service We assure 100%
                    data security.
                    <br>
                    <br>
                    At Lappystore - We ensure that you approve
                    the charges before we begin work. You can pay us by cash,
                    card, online transfer or PayTM.
                  </p>
                  <h5>Laptop Main Services</h5>
                  <ul>
                    ...
                    <li style="text-align: left">PANEL REPLACEMENT</li>
                    <li style="text-align: left">KEYPAD REPLACEMENT</li>
                    <!-- <li style="text-align: left">
