...
<!-- main-area -->
        <main>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumb-content">
                                <h2 class="title">Apple MacBook Series</h2>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Apple MacBook Series</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 col-sm-10 pb-100">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <a href="#"><img src="{{ asset('user/assets/img/lappy/i1.jpg') }}" alt=""></a>
                                </div>
                                <div class="team-content ">
                                    <h2 class="title"><a href="#">Macbook Pro A1398</a></h2>                                    
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <a href="team-details.html"><img src="{{ asset('user/assets/img/lappy/i2.jpg') }}" alt=""></a>
                                </div>
                                <div class="team-content">
                                    <h2 class="title"><a href="#">Macbook Air A1466 Model</a></h2>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <a href="team-details.html"><img src="{{ asset('user/assets/img/lappy/i3.jpg') }}" alt=""></a>
                                </div>
                                <div class="team-content">
                                    <h2 class="title"><a href="#">MacBook Pro A1707 15</a></h2>
                                    <!-- <span>CEO Kawasaki Inc.</span> -->
                                    <div class="team-social">
                                        <ul class="list-wrap" style="display: block;">
                                            <li><span>Sleek & Light Weight</span></li>
                        ...
                        <!-- <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <a href="team-details.html"><img src="assets/img/lappy/lp4.jpg" alt=""></a>
                                </div>
                                <div class="team-content">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <a href="team-details.html"><img src="assets/img/lappy/lp5.jpg" alt=""></a>
                                </div>
                                <div class="team-content">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-10">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <a href="team-details.html"><img src="assets/img/lappy/lp6.jpg" alt=""></a>
                                </div>
                                <div class="team-content">
            ...
            <!-- brand-area -->
            <!-- <section class="brand-area-two pt- pb-110">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
