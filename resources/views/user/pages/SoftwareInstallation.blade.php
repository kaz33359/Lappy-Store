                ...
                <div class="bd-content-top text-center">
                  ...
                  <div class="blog-details-img">
                    <img
                      ...
                      src="{{ asset('user/assets/img/lappy/laptoprepair.jpg') }}"
                      alt=""
                    />
                  </div>

                  <h2 class="title">Software Installation</h2>
                  <p style="text-align: left">
                    ...
                    upgrades, software migration service, software installation
                    services, and many other computer upgrade services in
