                ...
                <div class="bd-content-top text-center">
                  ...
                  <div class="blog-details-img">
                    <img
                      ...
                      src="{{ asset('user/assets/img/lappy/imacrepair.jpg') }}"
                      alt=""
                    />
                  </div>

                  <h2 class="title">iMac & iPad Repairs</h2>
                  <p style="text-align: left">
                    We’re here to help. Apple certified repairs are performed by
                    trusted experts who use genuine Apple parts.
                    <br />
                    <br />
                    Lappystore Team has a set of trained & certified technicians
                    who are expertized in Apple Mac products repairs & service.
                    We never send third party vendors to take care of your PC or
                    Laptop.
                    <br>
                    <br>
