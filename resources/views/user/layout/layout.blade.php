...
<html class="no-js" lang="en">
  <head>
    ...
    <!-- Primary Meta Tags -->
    <title>Lappy Store -  @yield('pagetitle')</title>
    <meta name="title" content="Lappy Store - The Digital Superstore" />
    <meta name="description" content="The Digital Superstore" />
    <meta name="author" content="Lappy Store - The Digital Superstore" />

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://thedaxads.com/" />
    <meta property="og:title" content="Lappy Store - The Digital Superstore" />
    <meta property="og:image" content="{{ asset('user/assets/img/lappy/logo/metaLogo.jpg') }}" />
    ...
    <meta
      ...
      content="Lappy Store - The Digital Superstore"
    />
    <meta
      property="twitter:image"
      content="{{ asset('user/assets/img/lappy/logo/metaLogo.jpg') }}"
    />

    <link
      rel="shortcut icon"
      type="image/x-icon"
      href="{{ asset('user/assets/img/lappy/logo/lappystore logo.png') }}"
    />
  ...
  <body>
      ...
      <div id="loader" class="loader">
        <div class="loader-container">
          <div class="loader-icon">
            <img src="{{ asset('user/assets/img/lappy/logo/lappyLogo.png')}}" alt="Preloader" />
          </div>
        </div>
      </div>
    </div>
    ...
    <a href="https://api.whatsapp.com/send?phone=919526977433" class="float" target="_blank">
              ...
              <div class="menu-wrap">
                <nav class="menu-nav">
                  <div class="logo">
                    <a href="index.html"
                      ><img
                        src="{{ asset('user/assets/img/lappy/logo/lappyLogo.png')}}"
                        alt="Logo"
                    /></a>
                  </div>
                  <div class="navbar-wrap main-menu d-none d-lg-flex">
                    <ul class="navigation">
                      ...
                      <li class="menu-item-has-children">
                        <a href="#">Business Desktop</a>
                        <ul class="sub-menu">
                          <li>
                            <a href="{{ url('/dellOptiplexSeries') }}"
                              >Dell Optiplex Series</a
                            >
                          </li>
                          <li>
                            <a href="{{ url('/HPProBookSeries') }}">HP ProBook Series</a>
                          </li>
                          <li>
                            <a href="{{ url('/LenovoThinkCentreSeries') }}"
                              >Lenovo ThinkCentre Series</a
                            >
                          </li>
                          <li>
                            <a href="{{ url('/AppleiMacSeries') }}">Apple iMac Series</a>
                          </li>
                        </ul>
                      </li>
                      <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                          <li>
                            <a href="{{ url('/DellLatitudeSeries') }}"
                              >Dell Latitude Series</a
                            >
                          </li>
                          <li>
                            <a href="{{ url('/HPEliteBookSeries') }}"
                              >HP EliteBook Series</a
                            >
                          </li>
                          <li>
                            <a href="{{ url('/LenovoThinkPadSeries') }}"
                              >Lenovo ThinkPad Series</a
                            >
                          </li>
                          <li>
                            <a href="{{ url('/AppleMacBookSeries') }}"
                              >Apple MacBook Series</a
                            >
                          </li>
                        </ul>
                      </li>
                      ...
                      <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                          <li>
                            <a href="{{ url('/ComputerRepairs') }}"
                              >Computer Repairs</a
                            >
                          </li>
                          <li>
                            <a href="{{ url('/LaptopRepair') }}">Laptop Repair</a>
                          </li>
                          <li>
                            <a href="{{ url('/iPadRepair') }}"
                              >iPad Repair</a
                            >
                          </li>
                          <li>
                            <a href="{{ url('/HardwareUpgrades') }}">Hardware Upgrades</a>
                          </li>
                          <li>
                            <a href="{{ url('/SoftwareInstallation') }}">Software Installation</a>
                          </li>
                        </ul>
                      </li>
                ...
                <nav class="menu-box">
                  ...
                  <div class="social-links">
                    <ul class="clearfix list-wrap">
                      <li>
                        <a href="https://www.facebook.com/LappyStoreUs"
                      ...
                      <li>
                        <a href="https://www.instagram.com/lappystore_official/"
                          ><i class="fab fa-instagram"></i
                        ></a>
                      </li>
                      <li>
                        <a href="https://www.linkedin.com/company/lappystore/"
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-6">
                      <div class="our-best-project">
                        ...
                        <div class="thumb">
                          <img
                            src="{{ asset('user/assets/img/images/our_project_img.png')}}"
                            alt=""
                          />
                        </div>
                      </div>
                ...
                <div class="customer-support-wrap">
                  ...
                  <div class="customer-support-content">
                    <div class="content-top">
                      <img src="{{ asset('user/assets/img/images/support_img.png')}}" alt="" />
                      <h4 class="title">Need Help Choosing a Plan?</h4>
                    </div>
                    <p>
                      We offer solutions for businesses of all sizes. For
                      questions about our plans and products,, contact our team
                      of experts. <a href="contact.html">Get in touch</a>
                    </p>
                  </div>
            ...
            <div class="row">
              <div class="col-lg-3 col-sm-6">
                <div class="footer-widget">
                  <div class="logo">
                    <a href="index.html"
                      ><img src="{{ asset('user/assets/img/lappy/logo/lappyLogo.png')}}" alt=""
                    /></a>
                  </div>
                  <div class="footer-social">
                    <ul class="list-wrap">
                      <li>
                        <a
                          href="https://www.facebook.com/LappyStoreUs"
                          target="_blank"
                          ><i class="fab fa-facebook-f"></i
                        ></a>
                      </li>
                      <li>
                        <a target="_blank" href="https://wa.me/+919526977433"
                          ><i class="fab fa-whatsapp" target="_blank"></i
                        ></a>
                      </li>
                      <li>
                        <a
                          href="https://www.instagram.com/lappystore_official/"
                          target="_blank"
                          ><i class="fab fa-instagram"></i
                        ></a>
                      </li>
                      <li>
                        <a
                          href="https://www.linkedin.com/company/lappystore/"
                          target="_blank"
                          ><i class="fab fa-linkedin-in"></i
                        ></a>
                      </li>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="footer-widget">
                  ...
                  <div class="footer-about">
                    <ul class="list-wrap">
                      <!-- <li><span>18/2, Suite 101,<br> Wellington Street,<br> Richmond Town,<br> Bangalore 560025</span></li>            -->
                      <li>
                        <span
                          >18/2 , Suite 101 ,<br> Wellington Street ,<br> Richmond Town , Bangalore 560025</span
                        >
                      </li>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="footer-widget">
                  ...
                  <div class="footer-about">
                    <ul class="list-wrap">
                      <li>
                        <img src="{{ asset('user/assets/img/icon/phone_icon.svg')}}" alt="" /><a
                          href="tel:919526977433"
                          >+91 95269 77433</a
                        >
                      </li>
                      <li>
                        <img src="{{ asset('user/assets/img/icon/mail_icon.svg')}}" alt="" /><a target="_blank"
                          href="mailto:sales@green-mayors.com"
                          >sales@green-mayors.com</a
                        >
                      </li>
                      <!-- <li>
                        <img
                          src="assets/img/icon/loction_icon.svg"
                          alt=""
                        /><span
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <div class="cart-img text-center">
                  <p>
                    © 2023 LAPPYSTORE | Designed by
                    <a href="https://thedaxads.com/" target="_blank">DaxAds</a>
                  </p>
                </div>
              </div>
            </div>
    ...
    <script src="{{ asset('user/assets/js/jquery.parallaxScroll.min.js')}}"></script>
    ...
    <script>
      ...
      //   }
        ...
        //   let i;
        //   let slides = document.getElementsByClassName("adImage1");
        ...
        function carousel() {
          var i;
          var x = document.getElementsByClassName("adImage1");
