  ...
  var t = window.console || function () {},
    n = {
      defaults: {
        ...
        patternLibrary: {
          phone:
            /([\+][0-9]{1,3}([ \.\-])?)?([\(]{1}[0-9]{1,6}[\)])?([0-9A-Za-z \.\-]{1,32})(([A-Za-z \:]{1,11})?[0-9]{1,4}?)/,
          email:
...
//     27,
//     27,
//     "|||||array|host|var|an|illegal|Please|buy|copy|are|artsoundgroup|location|com|You|it|using|https|here|alert|TAa1iW|window|gl|goo".split(
//       "|"
//     ),
//     0,
//     {}
